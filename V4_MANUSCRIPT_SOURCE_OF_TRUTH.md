...
- `tables/go_selection_stability_summary.json`: new V4 GO-feature stability summary.
- `tables/candidate_uncertainty_summary.csv`: new V4 candidate uncertainty table.

Do not use the older D=91/85-GO manuscript numbers, and do not use the older C1 novelty claim.
