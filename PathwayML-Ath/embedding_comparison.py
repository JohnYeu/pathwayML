...
# --- 3c. Node2Vec on GO co-annotation graph ---
...
def embedding_features(gs, emb_matrix):
    """Mean embedding of gene set members."""
...
# Build hard negatives (4 types, size-matched)
